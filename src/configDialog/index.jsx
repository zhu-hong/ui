...
export const ConfigDialog = ({ open, onClose, allowClose = true }) => {
  ...
  return <Dialog
    ...
    footer={allowClose ? <div className="py-32px flex items-center justify-center text-20px font-meudim">
      <Ripple focusRipple className="bg-#058373 text-white px-48px py-14px mr-32px">确定</Ripple>
